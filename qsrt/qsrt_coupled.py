"""Exact coupled activation-boundary coordinates for uniform-K2 QSRT.
...
class CoupledHadamardSpec:
    """Immutable transform parameters carried by the pure-K2 profile."""
    ...
    def __post_init__(self) -> None:
        ...
        if self.residual_draw != 0:
            raise ValueError("the qualified pure-K2 profile fixes residual draw zero")
