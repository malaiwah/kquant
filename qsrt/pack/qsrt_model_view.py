...
from qsrt.qsrt import FORMAT_X4T, PHASE1_MODE_IDS, ExpertFormatSpec
...
from qsrt.pack.qsrt_atoms_v2 import QSRTAtomsV2Reader, layer_filename
...
def validate_qsrt_atoms_v2_artifact(root: str | Path) -> dict:
