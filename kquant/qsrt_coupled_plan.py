"""Model-wide expert-static rotation plan for coupled uniform-K2 QSRT."""
...
from kquant.qsrt_coupled import CoupledHadamardSpec


KIND = "kquant_qsrt_k2_coupled_rotation_plan"
SCHEMA_VERSION = 1
...
class K2CoupledRotationPlan:
    ...
    @classmethod
    def from_json(cls, value: object) -> "K2CoupledRotationPlan":
...
def load_k2_coupled_rotation_plan(path: str | Path) -> K2CoupledRotationPlan:
    return K2CoupledRotationPlan.from_json(json.loads(Path(path).read_text()))
