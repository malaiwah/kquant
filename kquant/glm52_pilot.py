...
QSRT experiment machinery lives in :mod:`kquant.qsrt_codec_pilot`.
"""
...
from kquant.correctness import git_state, sha256_file
...
from kquant.qsrt import unpack_trellis_states
...
PILOT_KIND = "kquant_glm52_k3_codec_pilot_v1"
RATE_SHIFT_PILOT_KIND = "kquant_glm52_qsrt_codec_pilot_v1"
UNIFORM_RATE_PILOT_KIND = "kquant_glm52_uniform_rate_codec_pilot_v1"
UNIFORM_HIGH_RATE_PILOT_KIND = "kquant_glm52_uniform_k5_k6_codec_pilot_v1"
    ...
    *,
    ...
    for spec in PROJECTIONS:
        ...
        for rate in rates:
            ...
            baseline_weight, baseline_payload = arms["baseline"]
            sqg_weight, sqg_payload = arms["sqg"]
            energy, baseline_sse = metric_terms(source_weight, baseline_weight)
            sqg_energy, sqg_sse = metric_terms(source_weight, sqg_weight)
            if sqg_energy != energy:
                raise AssertionError("source energy changed between uniform codecs")
...
def aggregate_uniform_rate_records(
    ...
    *,
    ...
    for label in labels:
        ...
        result[label] = aggregate_records(views, panel=K4_PANEL)
    return result
...
def run_pilot(
    *,
    ...
    """Execute or resume the complete frozen 48-expert pilot."""
