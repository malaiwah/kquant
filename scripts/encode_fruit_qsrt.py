...
from qsrt.fruit_rate_evidence import FRUIT_RATE_SWEEP_SAMPLE_ASSIGNMENTS
...
def main() -> None:
    ...
    if (
        _QSRT_IMPORT_IDENTITY is not None
        and (
        ...
        raise ValueError("QSRT sources changed while importing the encoder")
    ...
    run_manifest = {
        "schema": "qsrt_fruit_qsrt_encode_run_v1",
        "version": 1,
