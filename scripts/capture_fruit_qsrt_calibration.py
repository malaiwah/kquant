...
from qsrt.candidate_hessian import weighted_covariance
...
from qsrt.fruit_source import FruitModelSpec
...
def _snapshot_calibration_inputs(
    ...
    temporary_directory = tempfile.TemporaryDirectory(
        prefix="qsrt-fruit-capture-inputs-"
    )
...
def _load_tokenizer(root: Path) -> Any:
    try:
        ...
        raise RuntimeError(
            "Fruit calibration tokenizer support is not installed; install QSRT "
            "with `qsrt[fruit-calibration]` (for a checkout: "
